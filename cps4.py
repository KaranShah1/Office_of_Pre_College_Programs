...
def create_cps_collection():
    if 'cps_vectorDB' not in st.session_state:
        # Set up the ChromaDB client
        persist_directory = os.path.join(os.getcwd(), "chroma_db")
        client = chromadb.PersistentClient(path=persist_directory)
        collection = client.get_or_create_collection("Cps_Collection")
        ...
        st.session_state.cps_vectorDB = collection

    return st.session_state.cps_vectorDB
